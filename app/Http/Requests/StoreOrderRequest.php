...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'lines.*.product_id' => ['nullable', 'integer', 'required_without:lines.*.combo_id', 'exists:products,id'],
            'lines.*.combo_id' => ['nullable', 'integer', 'exists:combos,id'],
            ...
            'packaging' => ['nullable', 'array', 'max:5'],
            'packaging.*' => ['string', Rule::in(['straws', 'paper_bag'])],
            'use_own_tumbler' => ['nullable', 'boolean'],
        ];
    }
}
