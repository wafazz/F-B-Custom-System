        ...
        <StorefrontLayout hideStats>
            ...
            {data && data.categories.length > 0 && (
                <div className="-mx-4 flex items-start gap-0">
                    <aside className="bg-muted/40 border-border sticky top-16 h-[calc(100vh-10rem)] w-20 shrink-0 self-start overflow-y-auto overscroll-contain border-r [-webkit-overflow-scrolling:touch]">
