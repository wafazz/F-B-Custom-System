...
class RewardPickupController extends Controller
{
    public function index(): Response
    {
        ...
        return Inertia::render('pos/reward-pickups', [
            'pending' => $pending,
    ...
    /**
     * Tablet-friendly endpoint: look up a pickup code (the customer reads it out
     * or the staff scans it via QR). Returns 404 if unknown so the page can
